...
window.addEventListener('scroll',()=>{
  ...
  if (window.scrollY > 10) {
    ...
    logo.style.width = 'clamp(1.1rem, 9.4vw, 6.6rem)';
    ...
    navContainer.style.display = 'flex';
    logo.style.width = 'clamp(4rem, 14.9vw, 10.5rem)';
    cart.style.width = 'clamp(1.3rem, 4.1vw, 3.2rem)';
    cartQuantity.style.fontSize= "clamp(6.5px, 1.5vw, 1.2rem)";
    cartQuantity.style.top='0%'
    navigation1.style.fontSize= "clamp(6px, 1.5vw, 1.2rem)";
    navigation2.style.fontSize= "clamp(6px, 1.5vw, 1.2rem)";
    navigation3.style.fontSize= "clamp(6px, 1.5vw, 1.2rem)";
    navigation4.style.fontSize= "clamp(6px, 1.5vw, 1.2rem)";
  }
});
